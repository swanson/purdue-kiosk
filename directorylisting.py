...
class DirectoryListing(QWidget):
    def __init__(self, parent = None):
        ...
        self.path = os.getcwd()
        self.widget.setStyleSheet(QApplication.translate("Form", "background-image: url(" + self.path + "/images/directorylisting.png);", None, QApplication.UnicodeUTF8))

        self.nameLabel = QLabel(self.widget)
        self.setName("Matt Swanson")
        self.nameLabel.setGeometry(QRect(220,50,400,100))
        ...
        self.emailLabel.setGeometry(QRect(220,130,400,100))
        ...
        self.phoneLabel.setGeometry(QRect(220,220,400,100))
        ...
        self.addrLabel.setGeometry(QRect(220,310,400,150))
        ...
        self.univLabel.setGeometry(QRect(220,420,400,150))
